...
int main ()
{
	...
	// Create data
	// pcl::PointCloud<pcl::PointXYZ>::Ptr cloud = CreateData(); // expirement Ransac for lines
    pcl::PointCloud<pcl::PointXYZ>::Ptr cloud = CreateData3D();

	// DONE: Change the max iteration and distance tolerance arguments for Ransac function
	// std::unordered_set<int> inliers = Ransac(cloud, 10, 0.5); // expirement Ransac for lines
